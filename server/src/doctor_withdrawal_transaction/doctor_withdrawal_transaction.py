...
from .doctor_withdrawal_transaction_enums import DoctorWithdrawalTransactionStatus


class DoctorWithdrawalTransaction(SQLEntity, Vld.PropertyTypeValidatorEntity):
    StatusType = DoctorWithdrawalTransactionStatus
    ...
    def db_table_name(self) -> str:
        return 'doctor_withdrawal_transactions'
