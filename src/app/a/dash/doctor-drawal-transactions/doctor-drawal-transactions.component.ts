...
@Component({
    selector: 'app-doctor-details-drawal-transactions',
    standalone: true,
    imports: [FontAwesomeModule, RouterLink, CommonModule, RouterOutlet, RouterLinkActive],
    templateUrl: './doctor-drawal-transactions.component.html',
    styleUrl: './doctor-drawal-transactions.component.scss',
})
export class DoctorDrawalTransactionsComponent implements AfterViewInit {
