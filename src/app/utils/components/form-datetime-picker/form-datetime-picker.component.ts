...
@Component({
    selector: 'form-datetime-picker', standalone: true, imports: [
        FormsModule, NgForOf, NgIf, NgClass, ReactiveFormsModule
    ], templateUrl: './form-datetime-picker.component.html', styleUrl: './form-datetime-picker.component.scss'
})
export class FormDatetimePickerComponent implements AfterViewInit, OnInit {
    static idCounter = 0;
    ...
    constructor(private rootFormGroup: FormGroupDirective) {
        this.id = FormDatetimePickerComponent.idCounter++;
    }
    ...
    initDatePicker(): void {
        ...
        this.datePickerTwInstance = new Datetimepicker(this.datePickerEle.nativeElement, {
            datepicker: {
                format: 'yyyy-mm-dd',
            },
            timepicker: {
    ...
    toShowError(): boolean | undefined {
        if (this.formGroup.get(this.controlName)?.touched ||
            ...
            FormDatetimePickerComponent.interactionStatuses[this.showErrorOn]) {
